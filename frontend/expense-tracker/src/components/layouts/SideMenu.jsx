  ...
  return <div className='w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/50 p-5 sticky top-[61px] z-20'>
        ...
        {SIDE_MENU_DATA.map((item, index) => (
            <button
                ...
                } py-3 px-6 rounded-lg mb-3 cursor-pointer hover:bg-gray-100 ${activeMenu != item.label ? "hover:text-primary" : "hover:bg-primary/90"} transition-colors duration-200`}
